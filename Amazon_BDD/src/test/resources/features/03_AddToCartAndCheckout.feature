Feature: Add to Cart and Checkout
  ...
  Scenario Outline: Add product from search result
  ...
  Scenario Outline: Increase quantity of item in cart
	...
	Examples:
    	| email 										| password |
    	| kumar2106rohan@gmail.com	| Varun@018072001|
	
	
 Scenario Outline: Checkout with saved address and payment
